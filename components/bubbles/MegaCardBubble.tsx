  ...
  return (
    ...
    >
      <div className="relative w-full overflow-hidden rounded-xl border border-border bg-card aspect-video">
        ...
        />
        <div className="pointer-events-none absolute inset-0 bg-gradient-to-t from-[hsl(var(--foreground)/0.7)] via-transparent to-transparent opacity-0 transition-opacity duration-200 group-hover:opacity-70 group-focus-visible:opacity-70" />
        <div
          className={[
            "pointer-events-none absolute inset-x-0 bottom-0 p-3",
            "text-sm font-medium leading-tight text-[hsl(var(--background))]",
