...
export default function Act1({ onDone }: { onDone?: () => void }) {
  ...
  function finish() {
    const handoff =
      "Okay… so these are Michael’s videos. They are not as good as mine but... whatever.\nJust click on them, or ask me anything you want!";
    try {
