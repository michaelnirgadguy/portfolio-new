...
export default function Act1FailWidget({ script, lineDelayMs = DEFAULT_DELAY }: Act1FailWidgetProps) {
  ...
  return (
    <div className="w-full overflow-hidden rounded-xl border border-border bg-card shadow-sm">
      <div className="relative h-6 border-b border-border text-sm text-muted-foreground">
        <div
          className="absolute left-3 top-1/2 -translate-y-1/2 overflow-visible"
          aria-label="hamster wheel spinning"
        >
